...
//    ISet<ElectricalSystem> allCircuits = mepModel.GetElectricalSystems();

//    HashSet<ElementId> loadCircuits =
//        mepModel.GetAssignedElectricalSystems()
//        .Select(es => es.Id)
//        .ToHashSet();

//    foreach (ElectricalSystem es in allCircuits)
//    {
//        if (!loadCircuits.Contains(es.Id))
//            return es; // питающая цепь
//    }
